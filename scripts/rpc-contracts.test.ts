...
const RPC_CONTRACTS = new Map<string, RpcContract>([
  ...
  ["platform_set_organization_status", [["p_org_id", "p_expected_version", "p_target_status", "p_reason", "p_actor_id", "p_actor_email", "p_policy_version", "p_request_id"]]],
  ["platform_open_support_case", [["p_org_id", "p_subject", "p_description", "p_priority", "p_first_response_due_at", "p_policy_version", "p_actor_id", "p_actor_email", "p_request_id"]]],
  ...
  ["platform_announcements_for_current_tenant", [[]]],
  ["platform_create_follow_up_task", [["p_org_id", "p_title", "p_reason", "p_source_type", "p_source_id", "p_assignee_id", "p_due_at", "p_next_step", "p_actor_id", "p_actor_email", "p_request_id"]]],
  ["platform_update_follow_up_task", [["p_task_id", "p_expected_version", "p_action", "p_assignee_id", "p_due_at", "p_outcome", "p_next_step", "p_reason", "p_actor_id", "p_actor_email", "p_request_id"]]],
  ...
  ["set_online_ordering_status", [["p_store_id", "p_enabled"]]],
...
const PLATFORM_ACTION_CONTRACTS = new Map<string, Map<string, string>>([
  ...
  ["src/app/platform/operations-actions.ts", new Map([
    ...
    ["transitionSupportCase", "support_manage"],
    ["assignSupportCase", "support_manage"],
    ["appendSupportCaseNote", "support_manage"],
  ...
  ["src/app/platform/follow-up-actions.ts", new Map([
    ["createPlatformFollowUpTask", "account_success_manage"],
    ["updatePlatformFollowUpTask", "account_success_manage"],
  ])],
