...
**Status:** Wave 1 and D2 are merged to `main`; hosted migrations `0088`, `0089`, and D2 ACL hardening `0091` are applied and verified. Hosted migration `0090` was applied during a concurrent announcement-delivery push and is now tracked in the repository for ledger consistency; the remaining D3 delivery code stays behind the C4 gate. Off-machine recovery evidence and owner sign-off remain external C4 gates.
...
**Updated:** 2026-09-23 · **Wave 1a headline:** 9 of 9 tracked slices complete (**100%**) · **Wave 1 local engineering:** 13 of 13 tracked slices complete (**100%**) · **Overall named-slice view:** 14 of 34 fully complete (**41%**). These are deliverable counts, not lines of code or elapsed time. PR #36 is merged to `main`; hosted migration `0088` is applied and verified. D2 is merged through PR #37, hosted `0089` and `0091` are applied, and the hosted attention smoke plus ACL checks pass. C4 recovery policy remains the next owner gate.
...
**Next gate:** C4 owner decisions and authenticated operator QA. Start D3 Merchant announcement delivery after the recovery policy and operator acceptance gates are closed.
