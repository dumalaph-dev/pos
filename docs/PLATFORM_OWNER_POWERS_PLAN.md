...
**Project:** Dumala POS
**Created:** 2026-08-29
**Status:** Phase 4 in progress — the audit, fleet, sync/outbox, and schema-drift read surfaces are deployed through `0084`; device inventory is deployed, pending authenticated operator QA and real terminal heartbeat validation
...
**Status:** In progress — audit, fleet, sync/outbox, and schema-drift surfaces are deployed through `0084`; device and terminal inventory is deployed to production (2026-09-14), pending authenticated operator QA and the first real terminal heartbeats
