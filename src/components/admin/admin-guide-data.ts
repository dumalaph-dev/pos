...
export const GUIDE_FAQS: GuideFaq[] = [
  ...
  // ---------------------------------------------------------------- Devices & offline
  {
    ...
    steps: [
      "Open POS → Counter Setup. It shows the link, a QR code, and the readiness checklist for whichever branch you are editing.",
      ...
      "Register the terminal under POS → Hardware so its sales carry a counter prefix and can print.",
    ],
    audiences: ["admin", "manager", "team", "cashier"],
    tags: ["tablet", "link", "cashier", "device", "QR", "counter", "staff link", "url", "counter setup"],
    href: "/admin/pos?tab=counter",
    linkLabel: "Open Counter Setup",
  },
  {
    id: "install-app",
    category: "Devices & offline",
...
export const QUICK_LINKS: Array<{ label: string; detail: string; href: string; icon: AdminIconName }> = [
  ...
  { label: "Counter setup", detail: "Branch link, QR, and terminal readiness", href: "/admin/pos?tab=counter", icon: "pos" },
