export type PosThemeId = "modern" | "classic" | "soft" | "dark" | "bold" | "coastal" | "sunset" | "botanical" | "ledger";

export const POS_THEME_IDS = ["modern", "classic", "soft", "dark", "bold", "coastal", "sunset", "botanical", "ledger"] as const;
...
export const POS_THEME_DEFINITIONS: Record<PosThemeId, PosThemeDefinition> = {
  ...
  sunset: {
    ...
    variables: {
      ...
      "--pos-theme-font": "Arial, Helvetica, sans-serif",
      "--pos-theme-app-pattern": "linear-gradient(135deg, rgba(231, 111, 81, 0.11) 0 9%, transparent 9% 18%, rgba(52, 34, 71, 0.07) 18% 27%, transparent 27% 100%) 0 0 / 72px 72px",
  ...
  ledger: {
    ...
    variables: {
      ...
      "--pos-theme-app-pattern": "linear-gradient(rgba(32, 38, 43, 0.035) 1px, transparent 1px), linear-gradient(90deg, rgba(32, 38, 43, 0.035) 1px, transparent 1px) 0 0 / 18px 18px",
