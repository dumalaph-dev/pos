  ...
  return (
    <main className="grid min-h-screen place-items-center bg-bg p-6 text-center text-ink">
      <div className="max-w-md rounded-card border border-line bg-surface p-8 shadow-[var(--shadow-pop)]">
        ...
        <button type="button" onClick={() => unstable_retry()} className="mt-6 rounded-btn bg-accent px-4 py-3 text-sm font-extrabold uppercase text-accent-fg transition hover:bg-accent-hover">Try again</button>
      </div>
    </main>
  );
}
