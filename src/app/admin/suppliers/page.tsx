...
export default async function SuppliersPage({
  ...
  const savedMessage = saved === "created" ? "Supplier added to the directory." : saved === "updated" ? "Supplier details updated." : "";
