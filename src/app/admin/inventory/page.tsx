    ...
    <main data-admin-theme={branding.theme} className="admin-page text-ink">
      <div className="min-w-0 px-4 pb-8 sm:px-6 lg:px-8">
        <AdminReadModelHydrator scope={cacheScope} batches={inventoryCacheBatches}>
          ...
          {catalogFieldsWarning && <div role="status" className="mt-5 rounded-card border border-warning/30 bg-warning/10 px-3 py-2.5 text-xs text-ink"><strong className="font-extrabold">Some inventory fields are unavailable.</strong> Ensure <code className="font-bold">0009_admin_business_records.sql</code>, <code className="font-bold">0010_inventory_catalog_fields.sql</code>, and <code className="font-bold">0073_recipe_inventory_model.sql</code> are applied in order in Supabase to enable suppliers and advanced inventory fields.</div>}
