...
const PLATFORM_NAV_GROUPS: PlatformNavGroup[] = [
  {
    ...
    items: [{ label: "Overview", href: "/platform", icon: "dashboard", detail: "Attention inbox and readiness" }],
  },
  {
    label: "Workspace",
    items: [
      ...
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-[236px] flex-col border-r border-[#2f5943] bg-[#15382a] text-[#fffaf1] lg:flex">
        <div className="flex min-h-0 flex-1 flex-col px-3.5 py-4">
          ...
          <div className="mt-4 shrink-0 border-t border-white/10 pt-3">
            <Link href="/admin" className="flex min-h-9 items-center gap-2 rounded-xl px-2.5 text-[11px] font-extrabold text-[#aec3b3] transition hover:bg-white/10 hover:text-[#fffaf1] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#d2a15c]"><AdminIcon name="arrow" size={14} /> Owner dashboard</Link>
